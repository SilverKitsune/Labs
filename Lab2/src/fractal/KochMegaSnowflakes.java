...
public class KochMegaSnowflakes {
    ...
    /**
     * @param c - координаты центра экрана
     * @param d - диаметр самой маленькой (скорее всего) описанной окружности (?)
     * @param m - к-во сторон снежинки
     * @param k - к-во снежинок
     * @param n - итерации кривой Коха
     * @param bc - цвет
     * @param ec - цвет
     */
    ...
    public static void main(String[] args) {
        ...
        drawKochMegaSnowflake(new Point2D.Double(WIDTH / 2, HEIGHT / 2),
                WIDTH / 3, 5, 5, 5, Color.RED, Color.BLUE);
